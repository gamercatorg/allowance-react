...
const initialDate = moment([2020, 3, 20])
const currentDate = moment()

const weeksToAdd = initialDate.diff(currentDate, "weeks")
...
allowance.getBalanceCents = (account) => initialData[account] + (weeksToAdd * 3)
